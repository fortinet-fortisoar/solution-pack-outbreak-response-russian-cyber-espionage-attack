...
2. From the list of solution pack that appears, search **Outbreak Response - Russian Cyber Espionage Attack**.
3. Click the **Outbreak Response - Russian Cyber Espionage Attack** solution pack card.
4. Click **Install** on the lower part of the screen to begin the installation.

## Prerequisites
The **Outbreak Response - Russian Cyber Espionage Attack** solution pack depends on the following solution packs that are installed automatically & if not already installed.
